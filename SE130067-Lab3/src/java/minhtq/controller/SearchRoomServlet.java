...
public class SearchRoomServlet extends HttpServlet {
    ...
    private static final org.apache.log4j.Logger LOGGER = org.apache.log4j.Logger.getLogger(SearchRoomServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String searchOption = request.getParameter("searchRoomOption").trim();
        ...
        try {
            ...
            roomDAO.getListRoomByKindOfRoom(hotelID, searchOption);
